...
import { name as SAGELINKName, init as defaultSAGELINK } from './apps/SAGELINK';
...
import { name as WritingTestName, init as defaultWritingTest } from './apps/WritingTest';
...
export const initialValues = {
  ...
  [WritingTestName]: defaultWritingTest,
};
