...
import { state as SAGELINKState, name as SAGELINKName } from './apps/SAGELINK';
...
import { state as WritingTestState, name as WritingTestName } from './apps/WritingTest';
