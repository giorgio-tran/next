...
import { name as NotesName } from './apps/Notes';
...
export const Applications = {
  ...
  [NotesName]: { AppComponent: React.memo(Notes.AppComponent), ToolbarComponent: Notes.ToolbarComponent, GroupedToolbarComponent: Notes.GroupedToolbarComponent },
